...
public:
   ...
   //get/put long(int64)
    static int64_t makeLong(char b7, char b6, char b5, char b4,
...
// -- get/put short --
inline
short  Bits::makeShort(char b1, char b0) {
...
inline
int64_t Bits::makeLong(char b7, char b6, char b5, char b4,
			 char b3, char b2, char b1, char b0)
{
...
inline
char  Bits::short1(short x) { return (char)(x >> 8); }

inline
char  Bits::short0(short x) { return (char)(x >> 0); }

inline
char  Bits::int3(int x) { return (char)(x >> 24); }

inline
char  Bits::int2(int x) { return (char)(x >> 16); }

inline
char  Bits::int1(int x) { return (char)(x >>  8); }

inline
char  Bits::int0(int x) { return (char)(x >>  0); }


inline
char  Bits::long7(int64_t x) { return (char)(x >> 56); }
inline
char  Bits::long6(int64_t x) { return (char)(x >> 48); }
inline
char  Bits::long5(int64_t x) { return (char)(x >> 40); }
inline
char  Bits::long4(int64_t x) { return (char)(x >> 32); }
inline
char  Bits::long3(int64_t x) { return (char)(x >> 24); }
inline
char  Bits::long2(int64_t x) { return (char)(x >> 16); }
inline
char  Bits::long1(int64_t x) { return (char)(x >>  8); }
inline
char  Bits::long0(int64_t x) { return (char)(x >>  0); }
