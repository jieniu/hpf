#ifndef _MYBASE_BYTEBUFFER_H_
#define  _MYBASE_BYTEBUFFER_H_
...
public:
    ...
    static   void* arraycopy(byte_2* src, int  srcPos, byte_2* dest, int destPos, int length);
    ...
    //byte
    byte_2 get() ;
    byte_2 get(int i) const;
    ByteBuffer& get(byte_2* dst, int dstLength, int offset, int length) ;
    ByteBuffer& get(byte_2* dst, int dstLength, int length) ;
    ...
    ByteBuffer& put(byte_2 x) ;
    ByteBuffer& put(int i, byte_2 x) ;
    ByteBuffer& put(const byte_2* src, int srcLength, int offset, int length) ;
    ByteBuffer& put(const byte_2* src, int srcLength, int length) ;
    ByteBuffer& put(const string& src, int offset) ;
    ByteBuffer& put(const string& src) ;
    ByteBuffer& put(ByteBuffer& src);
    ByteBuffer& putAsciiz(const byte_2* src, int srcLength);
...
inline
void* ByteBuffer::arraycopy(byte_2* src,  int  srcPos,
                            byte_2* dest, int destPos,
                            int length)
{
    byte_2*  _src = src+srcPos;
    byte_2* _dest = dest+destPos;
    /**
    if (from > to) {
    while (count-- > 0) {
...
inline
ByteBuffer& ByteBuffer::putAsciiz(const byte_2* src, int srcLength)
{
